...
// File contracts/integrations/lib/FullMath.sol
// License-Identifier: GPL-2.0-or-later
...
// File contracts/integrations/uniswap/ISwapRouter.sol
// License-Identifier: GPL-2.0-or-later
pragma abicoder v2;
...
// File contracts/mocks/wToken.sol
// License-Identifier: MIT
...
// File contracts/mocks/UniswapETHSwapperMock.sol
// License-Identifier: GPL-2.0-or-later
...
contract UniswapETHSwapperMock is ISwapRouter {
    ...
    constructor(address USDC, address vETH, wToken dcETH, address payable trigger) payable {
        _vETH = vETH;
        _dcETH = dcETH;
        _USDC = USDC;
        _trigger = trigger;
