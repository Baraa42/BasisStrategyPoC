...
// File contracts/token/DcToken.sol
// License-Identifier: MIT
...
contract DcToken is ERC20, Governance {
    using Address for address;

    constructor(string memory _name, string memory _symbol)ERC20(_name, _symbol){}

    function mint(address _to, uint256 _amount) external whenNotPaused() onlyGovernance() returns(bool) {
        _mint(_to, _amount);
        return true;
    }


    function burn(uint256 _amount) external whenNotPaused() onlyGovernance() returns(bool) {
...
// File contracts/DcTokenFactory.sol
// License-Identifier: MIT
